...
<body>
    ...
    <div class="p-4 space-y-4 sm:ml-64"> 
        ...
        <div class="flex space-x-2 mb-4">
            <a href="{{ route('admin.listpengembalian') }}"
                class="px-4 py-2 rounded-md text-sm font-medium transition
                {{ request()->is('Admin/listpengembalian*') && !request('bulan') ? 'bg-gray-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-500 hover:text-white' }}">
                Semua Buku
            </a>
            @php
                use Carbon\Carbon;
            ...
            <table class="w-full text-sm text-left text-gray-500">
                <thead class="text-xs text-white uppercase bg-gray-800">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">Pengembali</th>
                ...
                <div class="space-y-1">
                    ...
                    <div class="flex space-x-4 items-center">
                        <div class="flex space-x-1 items-center">
                            ...
                            <a href="{{ route('admin.export.pengembalian', ['bulan' => request('bulan'), 'tahun' => request('tahun', date('Y'))]) }}" class="text-sm hover:text-green-500">
                                Export Excel
                            </a>  
                        </div>
                        <div class="flex space-x-1 items-center">
                            <img class="h-8" src="{{ asset('img/pdf.png') }}" alt="">
                            <a href="{{ route('admin.export.pengembalian.pdf', ['bulan' => request('bulan'), 'tahun' => request('tahun', date('Y'))]) }}" class="text-sm hover:text-red-500">
                                Export pdf
                            </a>  
                        </div>
                    </div>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center">
        <div class="relative bg-white rounded-lg shadow-lg max-w-md w-full m-4">
            <div class="p-6">
                ...
                <p class="text-gray-600 mb-6">Apakah Anda yakin ingin menghapus data pengembalian yang dipilih?</p>
                <div class="flex justify-end space-x-4">
                    <button id="cancelDelete" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300">
                        Batal
                    </button>
                    <form id="deleteForm" action="{{ route('admin.delete.pengembalian') }}" method="POST">
                        @csrf
                        @method('DELETE')
