...
<body>
    ...
    <div class="p-4 space-y-4 sm:ml-64"> 
        ...
        <div class="flex space-x-2 mb-4">
            ...
            <form action="{{ route('admin.listpengembalian') }}" method="GET">
            ...
            <form action="{{ route('admin.listpengembalian') }}" method="GET">
                ...
                {{-- Menyertakan tahun jika sudah dipilih --}}
                @if(request('tahun'))
            ...
            <div class="space-y-1 w-full">
                ...
                <div class="flex space-x-4 items-center w-full">
                    ...
                    <div class="flex space-x-1 items-center">
                        ...
                        <a href="{{ route('admin.export.pengembalian.pdf', ['bulan' => request('bulan'), 'tahun' => request('tahun')]) }}" class="text-sm hover:text-red-500">
                            Export pdf
                        </a>  
                    </div>
