    ...
    <div class="flex max-md:flex-col max-md:justify-center max-md:h-screen max-md:items-center max-sm:mx-2 max-md:mx-20">
        ...
        <div class="max-lg:px-8 max-md:w-full max-lg:w-1/2 max-md:justify-center flex flex-col justify-center items-center w-2/5">
            ...
            <x-form action="/Auth/reset-password" method="POST" title="Lupa Password" buttonText="Send">
                ...
                <div>
                    <label for="password" class="max-sm:text-sm text-md p-4">Ulangi Password</label><br>
                    <div class="relative">
                        <input type="password" name="password_confirmation" id="password_confirmation" class="max-sm:text-sm rounded-full p-4 w-full hover:bg-gray-400 hover:placeholder-white outline-none" placeholder="Ulangi Password" required>
