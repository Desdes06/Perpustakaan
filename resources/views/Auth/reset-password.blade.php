...
<body>
    <div class="flex">
        <div class="bg-gradient-to-r from-blue-800 to-red-600 h-screen w-3/5 relative text-white">
            <div class="bg-black/15 h-screen p-9">
                ...
                <div class="flex flex-col items-center justify-center h-full space-y-2 px-auto">
                    <h1 class="text-7xl font-bold">Lupa Password !</h1>
                    <img class="p-12 mx-auto h-[70vh] w-auto hover:scale-105 transition-transform duration-300" src="{{ asset('img/d_art2.png')}}" alt="">
                </div> 
            </div>
        </div>
        <div class="flex flex-col justify-center items-center w-2/5 space-y-2">
            ...
            @endif
            <x-form action="/Auth/reset-password" method="POST" title="Lupa Password" buttonText="Send">
                @csrf
                <div>
                ...
                <div class="space-y-1">
                    <label for="password" class="text-md p-4">Ulangi Password</label><br>
                    <div class="relative">
                        <input type="password" name="password_confirmation" id="password_confirmation" class="rounded-full p-4 w-full hover:bg-gray-400 hover:placeholder-white outline-none" placeholder="Ulangi Password" required>
                ...
                @enderror 
                <div>
                    <input type="hidden" name="token" id="token" class="rounded-full p-4 w-full hover:bg-gray-400 hover:placeholder-white outline-none @error('password') is-invalid @enderror" value="{{ $token }}"> 
                </div>
            </x-form>
        </div> 
    </div>
