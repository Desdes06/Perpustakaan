    ...
    <div class="px-12 py-6 space-y-6 min-h-screen max-sm:p-2">
        ...
        <div class="space-y-12 pb-12">
            ...
            <div class="space-y-4 bg-[#413C88]/20 p-8 rounded-md max-sm:p-2">
                ...
                @else
                <section class="w-full overflow-x-auto pb-4">
                        ...
                        <div class="h-92 w-56 max-sm:w-[11.75rem] bg-white hover:shadow-xl">
                            <a href="{{ route('User.detail', ['id' => $br->id]) }}">
                                <div class="h-auto">
                                    ...
                                    @else
                                        <div class="w-full max-sm:h-64 h-80 bg-gray-400 flex justify-center items-center flex-col">
                        ...
                        <div class="h-92 w-56 max-sm:w-[11.75rem] bg-[#413C88]/20 hover:shadow-xl">
                            <a href="{{ route('User.detail', ['id' => $b->id]) }}">
                                <div class="h-auto">
                                    ...
                                    @else
                                        <div class="w-full max-sm:h-64 h-80 bg-gray-400 flex justify-center items-center flex-col p-2">
