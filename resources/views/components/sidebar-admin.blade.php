    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-800 flex flex-col justify-between">
       <ul class="space-y-2 font-medium">
        ...
        <li>
         ...
         <li>
            <a href="/Admin/pesanadmin" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group relative">
                ...
                @if ($totalPesan > 0)
                    <span class="bg-red-600 text-white text-xs font-bold rounded-full px-2 py-1">
                        {{ $totalPesan }}
                    </span>
                @endif
            </a>
